...
<div class="position-fixed top-0 end-0 start-0 bg-img-start" style="height: 32rem; background-image: url({{ asset('dist/assets/svg/components/card-6.svg') }});">
      <!-- Shape -->
    ...
    <div class="container py-5 py-sm-7">
      <a class="d-flex justify-content-center mb-5" href="./index.html">
        <img class="zi-2" src="{{asseT('images/logoidex.png')}}" alt="Image Description" style="width: 8rem;">
      </a>
      ...
      <div class="mx-auto" style="max-width: 30rem;">
        ...
        @csrf
              ...
              <div class="mb-4">
                ...
                <input id="email" type="email" class="form-control form-control-lg" name="email" id="signinSrEmail" tabindex="1"   aria-label="email@address.com"   :value="old('email')" required autofocus autocomplete="username">
              ...
              <div class="mb-4">
                ...
                <div class="input-group input-group-merge" data-hs-validation-validate-class>
                  <input   type="password" class="js-toggle-password form-control form-control-lg"   id="signupSrPassword"   data-hs-toggle-password-options='{
                           "target": "#changePassIcon",
              ...
              <div class="form-check mb-4">
                <input  type="checkbox"  name="remember"  class="form-check-input"  value="" id="termsCheckbox">
  ...
  <script src="{{asset('dist/assets/vendor/hs-toggle-password/dist/js/hs-toggle-password.js')}}"></script>
