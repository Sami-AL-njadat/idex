 ...
 @section('content')
                                     ...
                                     <select name="blog_id" id="blog_id" class="js-select form-select" autocomplete="off">
                                         ...
                                         @foreach ($blogs as $blog)
                                             <option value="{{ $blog->id }}"
                                                 {{ $article->blog_id == $blog->id ? 'selected' : '' }}>
                                                 {{ $blog->title }}
                                             </option>
                                         @endforeach
                                     </select>
                        ...
                        "modules": {
                            "toolbar": [
                                ["bold", "italic", "underline", "strike", "link", "blockquote", "code", {"list": "bullet"}]
                                 ...
                                 <textarea name="paragraph" style="display:none;">{!! $article->paragraph ?? '' !!}</textarea>
                             </div>
                             <div class="mb-4">
                                 <label class="form-label">
                                 ...
                                 <input type="text" class="form-control" name="header_two"
                                     placeholder="Enter header two here" value="{{ $article->header_two ?? '' }}">
                             </div>
                             <div class="mb-4">
                                 <label class="form-label">
                        ...
                        "modules": {
                            "toolbar": [
                                ["bold", "italic", "underline", "strike", "link", "blockquote", "code", {"list": "bullet"}]
                                 ...
                                 <textarea name="paragraph_two" style="display:none;">{!! $article->paragraph_two ?? '' !!}</textarea>
                             </div>
                                         ...
                                         <div class="dz-dropzone-card" id="dropzone1">
                                             <div style="width: 100%; text-align: center;">
                                                 <img style="width: 150px;height: 100px;" id="showImageDefault1"
                                                     ...
                                                     src="{{ isset($article) && $article->image1 ? asset($article->image1) : asset('dist/assets/svg/illustrations/oc-browse.svg') }}"
                                         ...
                                         <div class="dz-dropzone-card" id="dropzone2">
                                             <div style="width: 100%; text-align: center;">
                                                 <img style="width: 150px;height: 100px;" id="showImageDefault2"
                                                     class="card-img-top mb-3" style="height: 150px !important ;width:100px"
                                                     src="{{ isset($article) && $article->image2 ? asset($article->image2) : asset('dist/assets/svg/illustrations/oc-browse.svg') }}"
                                                     alt="Image Description" data-hs-theme-appearance="default">
     ...
     <script>
         ...
         document.querySelector('#formArticleUpdate').addEventListener('submit', function(event) {
